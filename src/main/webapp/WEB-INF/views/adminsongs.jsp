     ...
     %>
        <div class="container">
            ...
            <div>
                ...
                <div>
                    <table class="table table-light table-striped table-bordered table-sm" border='1'
                        ...
                        <% 
                        	@SuppressWarnings("unchecked") List<Song> songs = (List<Song>)
                             session.getAttribute("songs");
                         %>
                         <% 
                         	for (Song s : songs) { 
                         ...
                         <tr class="table align-middle" style="text-align: center">
                             ...
                             <td><a class="btn btn-warning"
                                     href="/admin/songs/editsong/<%=s.getId()%>">Edit</a>
                             </td>
                             <td><a class="btn btn-danger"
                                     href="/admin/songs/deletesong/<%=s.getId()%>">Delete</a>
                             </td>
                         </tr>
                         <% } %>
                    </table>
