	...
	<div>
		<form method="post">
			<div>
				...
				<input type="text" name="imageUrl" value="${song.getImageUrl()}">
			</div>

			<div>
				<label>Song Title</label> 
				<input type="text" name="title" value="${song.getTitle()}">
			</div>
			
			<div>
				<label>Song Description</label> 
				<input type="text" name="description" value="${song.getDescription()}">
			</div>
